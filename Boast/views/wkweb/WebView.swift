...
//    var isPreview: Bool
//    
//    init(kguard: KeyboardGuardian, defaultValue: String, options: [String: Any], isPreview: Bool, theme: String?, syntax: String?, editorState: EditorState) {
//        self.kguard = kguard
...
//            }
//            
//            message.webView?.evaluateJavaScript("window.setDefaultValue(\(jsonDefaultValue), \(isPreview))", completionHandler: nil)
...
//        WebView(kguard: KeyboardGuardian(), defaultValue: "", options: [:], isPreview: true, loading: .constant(true))
//    }
//}
